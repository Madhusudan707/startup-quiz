                            ...
                            <div className="flex flex-col items-center lg:w-2/4">
                                {
                                    isUserLoggedIn
                                        ...
                                        :
                                        <a href='#login' className="bg-gray-100 lg:p-4 p-3 uppercase lg:text-1xl text-1xl text-green-500 rounded-full shadow-lg focus:outline-none hover:bg-green-500 hover:text-white">{info[0].category}</a>
                                }
                            </div>
                        </div>
                    )
