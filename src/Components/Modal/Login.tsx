        ...
        <>
            ...
            <div id="login" className="modal w-full flex flex-col items-center justify-center ">
                <div className="flex items-center h-screen w-full relative ">
                    <Close nameClass="text-gray-500 hover:text-red-500 text-3xl absolute top-8 right-40 " />
                        ...
                        <form className="mb-4" onSubmit={loginUser}>
                            <div className="flex flex-col">
                                <div className="mb-4 md:w-full">
                                    ...
                                    <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="email" name="email" defaultValue="test@gmail.com" placeholder="Email" onChange={(e) => { setUserName(e.target.value) }} />
                                </div>
                                <div className="mb-6 md:w-full">
                                    <label htmlFor="password" className="block text-xs mb-1">Password</label>
                                    <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="password" defaultValue="12345678" name="password" placeholder="Password" onChange={(e) => { setPassword(e.target.value) }} />
                                </div>
